...
<div class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
    <?php if(isset($success)): ?>
        <div class="fixed top-20 right-4 w-96 bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded-lg shadow-lg flex items-center space-x-3">
    ...
    <?php if(isset($errors)): ?>
        <div class="fixed top-20 right-4 w-96 bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-lg shadow-lg flex items-center space-x-3">
            ...
            <div class="flex-1"><?php echo $errors; ?></div>
        </div>
    <?php endif; ?>
        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10 flex flex-col justify-center">
                ...
                <div class="flex items-center justify-center mt-2">
                    ...
                    <a href="/signup" class="text-indigo-500 ml-2">SignUp</a>
                </div>
            </div>
        </div>
    </div>
