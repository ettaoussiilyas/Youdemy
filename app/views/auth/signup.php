...
<div class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5 ">
    <?php if(isset($success)): ?>
        <div class="fixed top-4 right-4 w-96 bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded-lg shadow-lg flex items-center space-x-3">
    ...
    <?php endif; ?>
    <?php if(isset($errors)): ?>
        <div class="fixed top-20 right-4 w-96 bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-lg shadow-lg flex items-center space-x-3">
            <div class="flex-shrink-0">
                <svg class="h-5 w-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                </svg>
            </div>
            <div class="flex-20"><?php echo $errors; ?></div>
        </div>
    <?php endif; ?>
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden mt-16" style="max-width:1000px">
                ...
                <form method="post" action="/signup" class="space-y-6">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center">
                            ...
                            <label for="student" class="ml-2">Student</label>
                        </div>
                        <div class="flex items-center">
